...
type User struct {
	...
	// special
	// @gotags: json:"is_admin,omitempty"
	IsAdmin       bool `protobuf:"varint,50,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"`
...
const file_model_user_proto_rawDesc = "" +
	"\n" +
	"\x10model/user.proto\x12\x05model\"a\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12\x19\n" +
	"\bis_admin\x182 \x01(\bR\aisAdminB>Z<github.com/bouncingmaxt/omniscent-library/gen/go/model;modelb\x06proto3"
